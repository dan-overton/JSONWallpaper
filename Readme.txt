...
A windows tray app which rotates wallpaper based on the chromecast-backgrounds (https://github.com/dconnolly/chromecast-backgrounds) backgrounds.json format.

Windows tray code based on "Creating Tray Applications in .NET - A Practical Guide" 
(https://www.simple-talk.com/dotnet/.net-framework/creating-tray-applications-in-.net-a-practical-guide/) by Michael Sorens.
